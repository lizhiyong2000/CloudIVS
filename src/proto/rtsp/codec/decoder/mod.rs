macro_rules! try_complete {
    ($result:expr) => {
        match $result {
            crate::proto::rtsp::codec::decoder::DecodeResult::Complete(value) => value,
            crate::proto::rtsp::codec::decoder::DecodeResult::Error(error) => {
                return crate::proto::rtsp::codec::decoder::DecodeResult::Error(error.into());
            }
            crate::proto::rtsp::codec::decoder::DecodeResult::Incomplete => {
                return crate::proto::rtsp::codec::decoder::DecodeResult::Incomplete;
            }
        }
    };
}
