macro_rules! try_complete {
    ($result:expr) => {
        match $result {
            crate::protocol::rtsp::protocol::codec::decoder::DecodeResult::Complete(value) => value,
            crate::protocol::rtsp::protocol::codec::decoder::DecodeResult::Error(error) => {
                return crate::protocol::rtsp::protocol::codec::decoder::DecodeResult::Error(error.into());
            }
            crate::protocol::rtsp::protocol::codec::decoder::DecodeResult::Incomplete => {
                return crate::protocol::rtsp::protocol::codec::decoder::DecodeResult::Incomplete;
            }
        }
    };
}
