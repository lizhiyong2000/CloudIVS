...
impl SrtpContext {
    ...
    pub fn decrypt(&mut self, packet: &[u8]) -> Result<Vec<u8>> {
        ...
        let header = track_try!(crate::protocol::rtp::rtp::RtpFixedHeader::read_from(reader));
...
mod test {
    ...
    fn rtp_decryption_works() {
        ...
        let mut rtp_reader = SrtpPacketReader::new(context, crate::protocol::rtp::rtp::RtpPacketReader);
